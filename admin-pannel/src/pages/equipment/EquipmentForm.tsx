        ...
        <div className="space-y-6 p-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Card className="bg-white dark:bg-dark-900/50 border-gray-200 dark:border-dark-800">
                    <CardHeader>
                        <CardTitle className="text-gray-900 dark:text-white">Equipment Information</CardTitle>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="md:col-span-2">
                                <Label htmlFor="name" className="text-gray-700 dark:text-gray-300">
                                    Equipment Name <span className="text-red-500 dark:text-red-400">*</span>
                                </Label>
                                <Input
                                    id="name"
                                    {...register('name')}
                            ...
                            <div>
                                ...
                                <Select onValueChange={(value) => setValue('category', value)}>
                                    <SelectTrigger className="bg-white dark:bg-dark-800 border-gray-200 dark:border-dark-700 text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="bg-white dark:bg-dark-800 border-gray-200 dark:border-dark-700 text-gray-900 dark:text-white font-mono"
                                    placeholder="FT-X3000-2025-1234"
                                />
                                {errors.serialNumber && (
                                    <p className="text-xs text-red-500 dark:text-red-400 mt-1">{errors.serialNumber.message}</p>
                                )}
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card className="bg-white dark:bg-dark-900/50 border-gray-200 dark:border-dark-800">
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <Label htmlFor="purchaseDate" className="text-gray-700 dark:text-gray-300">
                                    Purchase Date
                                </Label>
                                <Input
                                    id="purchaseDate"
                            ...
                            <div>
                                <Label htmlFor="purchasePrice" className="text-gray-700 dark:text-gray-300">
                                    Purchase Price ($)
                                </Label>
                                <Input
                                    id="purchasePrice"
                            ...
                            <div>
                                <Label htmlFor="supplierName" className="text-gray-700 dark:text-gray-300">
                                    Supplier Name
                                </Label>
                                <Input
                                    id="supplierName"
                            ...
                            <div>
                                <Label htmlFor="warrantyMonths" className="text-gray-700 dark:text-gray-300">
                ...
                <Card className="bg-white dark:bg-dark-900/50 border-gray-200 dark:border-dark-800">
                    <CardHeader>
                        <CardTitle className="text-gray-900 dark:text-white">Location & Specifications</CardTitle>
                        <CardDescription className="text-gray-500 dark:text-gray-400">
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                {errors.location && (
                                    <p className="text-xs text-red-500 dark:text-red-400 mt-1">{errors.location.message}</p>
                                )}
                            </div>

                            <div>
                                <Label htmlFor="weightCapacity" className="text-gray-700 dark:text-gray-300">
                                    Weight Capacity
                                </Label>
                                <Input
                                    id="weightCapacity"
                            ...
                            <div>
                                <Label htmlFor="dimensions" className="text-gray-700 dark:text-gray-300">
                                    Dimensions (L × W × H)
                                </Label>
                                <Input
                                    id="dimensions"
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <Label className="text-gray-700 dark:text-gray-300">Technical Specifications</Label>
                                <Button
                                    type="button"
                                    variant="outline"
                                    size="sm"
                            ...
                            <div className="space-y-2">
                                {specifications.map((spec) => (
                                    <div
                                        key={spec.id}
                                        className="grid grid-cols-2 gap-3 p-3 rounded-lg bg-gray-50 dark:bg-dark-800/50 border border-gray-200 dark:border-dark-700"
                                    >
                                        <Input
                                            value={spec.key}
                                            onChange={(e) =>
                ...
                <Card className="bg-white dark:bg-dark-900/50 border-gray-200 dark:border-dark-800">
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <Label htmlFor="maintenanceFrequency" className="text-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                <Label htmlFor="lastMaintenanceDate" className="text-gray-700 dark:text-gray-300">
                        ...
                        <div>
                            <Label htmlFor="maintenanceNotes" className="text-gray-700 dark:text-gray-300">
                                Maintenance Notes
                            </Label>
                            <Textarea
                                id="maintenanceNotes"
