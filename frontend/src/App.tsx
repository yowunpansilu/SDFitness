...
import BodyMeasurements from './pages/dashboard/BodyMeasurements';
import WorkoutPRs from './pages/dashboard/WorkoutPRs';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dashboard" element={
            ...
            <Route path="weekly-progress" element={<WeeklySchedule />} />
            <Route path="measurements" element={<BodyMeasurements />} />
            <Route path="prs" element={<WorkoutPRs />} />
