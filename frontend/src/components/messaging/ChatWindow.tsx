        ...
        return (
            <div className="flex-1 flex items-center justify-center bg-white h-full relative overflow-hidden">
                ...
                <div className="text-center relative z-10 px-6">
                    ...
                    <h2 className="text-2xl font-black text-navy-900 tracking-tight uppercase italic mb-2">No active discussion</h2>
                    <p className="text-navy-400 font-bold text-sm max-w-[280px] mx-auto leading-relaxed">
                        Select a conversation from the sidebar or start a new message to get moving.
                    </p>
                </div>
            </div>
        );
