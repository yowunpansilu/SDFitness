        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden border-none shadow-2xl bg-white/95 backdrop-blur-xl">
                <DialogHeader className="p-6 pb-2">
                    <DialogTitle className="text-2xl font-black text-navy-900 tracking-tight italic uppercase">Start Conversation</DialogTitle>
                </DialogHeader>
                <div className="px-6 py-4">
                    <div className="relative mb-6">
                        <Search className="absolute left-3 top-3 h-4 w-4 text-navy-400" />
                        <Input
                            placeholder="Find a trainer or admin..."
                    ...
                    <div className="space-y-1 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                        {filteredUsers.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-sm font-bold text-navy-400">No users found</p>
                            </div>
                        ) : (
