                                ...
                                {editingId === log._id ? (
                                    <div className="flex items-center gap-2">
                                        <Input 
                                            ...
                                            autoFocus
                                        />
                                        <span className="text-sm text-muted-foreground mr-2">{log.weight.unit}</span>
                                    ...
                                    <>
                                        <span className="text-lg font-bold text-foreground">
                                            {log.weight.value.toFixed(1)} <span className="text-sm font-normal text-muted-foreground">{log.weight.unit}</span>
                                        </span>
                                        <div className="flex gap-1 ml-4 opactiy-50 hover:opacity-100 transition-opacity">
                                            <Button size="icon" variant="ghost" className="h-8 w-8 text-muted-foreground hover:text-primary" onClick={() => { setEditingId(log._id); setEditValue(log.weight.value.toString()); }}>
