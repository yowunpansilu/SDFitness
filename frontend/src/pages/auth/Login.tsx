      ...
      <div className="auth-card">
        <form onSubmit={handleSubmit(onSubmit)} className="auth-form">
          ...
          <div className="input-wrap mb-4">
            ...
            />
            {errors.email && (
              <span className="absolute -bottom-5 left-2 text-[10px] text-red-500 font-bold uppercase tracking-widest">{errors.email.message}</span>
            )}
          </div>
          ...
          <div className="input-password-wrap mb-0 relative">
            ...
            {errors.password && (
              <span className="absolute -bottom-5 left-2 text-[10px] text-red-500 font-bold uppercase tracking-widest">{errors.password.message}</span>
            )}
          </div>
          ...
          <button type="submit" className="btn-brand mt-4" disabled={isSubmitting}>
        ...
        <div className="auth-footer text-center mt-6">
           <span className="auth-footer__text text-ink-muted text-sm inline-block mr-1">Don't have an account?</span>
           <span className="auth-footer__link text-brand font-bold text-sm cursor-pointer hover:underline" onClick={() => navigate('/register')}>Sign Up</span>
        </div>
      </div>
    </div>
  );
